...
# ACCOUNT SETTINGS
# ==============================
STARTING_EQUITY: float = 12508.0  # Active trading equity (buying power only)

# ==============================
# API KEYS & ENDPOINTS
# ==============================
ALPACA_API_KEY: str = "PK8M9MBNXGDYTL16TFSU"
ALPACA_SECRET_KEY: str = "RLabZrn9mk32TlJnSX18EDN4FltzIQWv96y1weZs"
ALPACA_BASE_URL: str = "https://paper-api.alpaca.markets"
ALPACA_DATA_URL: str = "https://data.alpaca.markets/v2"

POLYGON_API_KEY: str = "1Q25zdVF4QNmjWxxqW6PpTMCf8LmeSWz"
POLYGON_BASE_URL: str = "https://api.polygon.io"

DISCORD_WEBHOOK: str = "https://discord.com/api/webhooks/1419689031410782228/-mSTaiTHMRK2SmwZ7Sb8CI7eMYPqiwtIhNSekPb_kDJmA_Vy7azcdhscNrjS9rREl_Eu"
...
BACKTEST_SYMBOLS: list[str] = ["SPY"]     # Default symbol(s)
BACKTEST_START: str = "2024-01-01"
BACKTEST_END: str = "2024-12-01"
BACKTEST_TIMEFRAME: str = "1Min"          # "1Min", "5Min", "15Min", "1Day"
BACKTEST_EXPIRY_DAYS: list[int] = [0, 1, 2, 3, 4, 5, 6, 7]  # Expiries allowed (0DTE, 1DTE)
...
# ==============================
# LOGGER FACTORY (Windows safe, no emojis)
# ==============================
def get_logger(name: str) -> logging.Logger:
    """Logger factory with file + console handlers, safe for Windows encoding."""
